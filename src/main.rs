...
fn main() -> CliResult {
    ...
    match args {
        ...
        DesfireTool::Application {
            application_command,
        } => commands::application(application_command),
        DesfireTool::File {
            file_command,
            aid,
            fid,
        } => commands::file(file_command, aid, fid),
...
#[structopt(
    name = "desfire-tool",
    about = "Tool to interact with DesFire Cards",
...
enum DesfireTool {
    ...
    Key {
        ...
        #[structopt(
            short = "aid",
            long = "appid",
            help = "Application ID to perform operation for"
        )]
        aid: u8,
    },
    #[structopt(
    ...
    File {
        ...
        #[structopt(
            short = "aid",
            long = "appid",
            help = "Application ID the file belongs to"
        )]
        aid: u8,
        #[structopt(
            short = "fid",
            long = "fileid",
            help = "File ID to perform operation for"
        )]
        fid: u8,
    },
    #[structopt(
...
pub enum KeyCommand {
    ...
    Configure {
        #[structopt(
            short = "kid",
            long = "keyid",
            help = "Key ID to perform operation for"
        )]
        kid: u8,
    },
    ...
    Info {
        #[structopt(
            short = "kid",
            long = "keyid",
            help = "Key ID of the Key to display info for"
        )]
        kid: u8,
    },
    #[structopt(name = "list")]
...
pub enum ApplicationCommand {
    ...
    Add {
        #[structopt(
            short = "aid",
            long = "appid",
            help = "App ID to perform operation for"
        )]
        aid: u8,
    },
    #[structopt(name = "configure")]
    ...
    Info {
        #[structopt(
            short = "aid",
            long = "appid",
            help = "App ID of the App to display info for"
        )]
        aid: u8,
    },
    #[structopt(name = "list")]
